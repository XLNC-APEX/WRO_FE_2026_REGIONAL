...
class ObstacleDetection:
    ...
    def get_correction(self):
        ...
        if red_count > 0 and 30 < self.red_obstacles[1][0].y_center < 200 and red_area > green_area:
            ...
            if green_area >= MIN_OBSTACLE_AREA and 30 < self.green_obstacles[1][0].y_center < 200:
